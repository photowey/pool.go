...
.PHONY: bench-smoke
bench-smoke:
	$(GO) test -run '^$$' -bench='Benchmark(ExecutorExecuteFixed|ExecutorSubmitFixed|FutureAwaitCompleted)' -benchmem -benchtime=100ms -count=1 ./benchmarks
